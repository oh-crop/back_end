...
Revision ID: dc382319dd84
Revises: 8c089a511ab7
Create Date: 2020-07-20 20:57:23.243476
...
def upgrade():
    ...
    op.bulk_insert('plants_table',
      [
        ...
        {'id':8,'name':'Venus','plant_type':'Venus Fly Trap','image':'https://p0.pikist.com/photos/62/950/venus-fly-trap-plant-green-thumbnail.jpg','lighting':'Full Sun','water_frequency':3,'root _depth':4,'annual':False},
        ...
        {'id':10,'name':'Kenai','plant_type':'Bear Paw','image':'https://cdn.shopify.com/s/files/1/2391/9491/products/image_ff75aeba-99e0-4791-b21b-74580ff9303b_1024x1024.jpg?v=1571710608','lighting':'Full Sun','water_frequency':7,'root _depth':4,'annual':False},
        {'id':11,'name':'Ken','plant_type':'Bamboo','image':'https://cdn.pixabay.com/photo/2020/05/24/11/53/bamboo-5213909_960_720.jpg','lighting':'Indirect Sun','water_frequency':4,'root _depth':36,'annual':False},
        ...
        {'id':21,'name':'Sunshine','plant_type':'Daffodil','image':'https://p0.pikist.com/photos/246/87/daffodils-spring-flowers-daffodil-bloom-nature-yellow-petals-garden.jpg','lighting':'Full Sun','water_frequency':7,'root _depth':6,'annual':False},
        {'id':22,'name':'Hades','plant_type':'Sunflower','image':'https://p0.pikist.com/photos/348/318/sunflower-yellow-flower-yellow-sun-flower-plant-nature-summer-field-of-sunflowers.jpg','lighting':'Full Sun','water_frequency':7,'root _depth':24,'annual':False},
        {'id':23,'name':'Mort','plant_type':'Bleeding Heart','image':'https://images.pexels.com/photos/414362/pexels-photo-414362.jpeg?cs=srgb&dl=beautiful-bleeding-heart-bloom-blooming-414362.jpg&fm=jpg','lighting':'Full/Partial Shade','water_frequency':7,'root _depth':6,'annual':False},
        {'id':24,'name':'Judy','plant_type':'Foxglove','image':'https://upload.wikimedia.org/wikipedia/commons/d/da/Purple_Foxglove_%28Digitalis_purpurea%29_2008_03.jpg','lighting':'Full/Partial Shade','water_frequency':7,'root _depth':10,'annual':False},
      ]
    )
